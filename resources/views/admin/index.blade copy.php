                                        ...
                                        <div class="px-2 pb-2 ">
                                            ...
                                            <div class="row flex-nowrap overflow-auto  py-2 px-1" style="white-space: nowrap; min-height: 0;">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                                                    <div class="card shadow-sm p-2 text-center   " style="background-color: #0A415B; color: #d1d5db; border-top-right-radius: 12px;border-top-left-radius: 12px;border-bottom-left-radius: 0px;border-bottom-right-radius: 0px;border-bottom:2px solid #25D366">
                                                        <div class="d-flex flex-column justify-content-center align-items-center gap-2 " style="min-height: 150px;">
                                                            <!-- Number -->
                                                            <div class="fw-bold text-white p-3 rounded"
                                                            style="background: linear-gradient(to bottom, #105A7E, #082D3F); font-size: 24px;">
                                                           259
                                                       </div>
                                                        <div>
